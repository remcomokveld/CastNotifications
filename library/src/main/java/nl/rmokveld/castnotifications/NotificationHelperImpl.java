...
class NotificationHelperImpl implements NotificationHelper {
    ...
    @Override
    public void add(CastNotification castNotification, Map<String, String> availableRoutes) {
        mCastNotifications.put(castNotification.getId(), castNotification);
        postNotification(castNotification, availableRoutes);
    }

    @Override
    public void addAll(List<CastNotification> castNotifications, Map<String, String> availableRoutes) {
    ...
    @Override
    public void postNotification(CastNotification castNotification, Map<String, String> castDevices) {
